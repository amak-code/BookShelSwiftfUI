...
class BookViewModel: ObservableObject {
    ...
    func loadBooks() {
        if books.isEmpty {
            books = [
                Book(title: "The 10X Rule: The Only Difference Between Success and Failure", author: "Grant Cardone ", coverArt: "10x", releaseYear: "2011", description: """
                ...
                Book(title: "The Four Maps of Happy Successful People: A Visual System for Personal Change", author: "Robert G. Allen", coverArt: "FourMaps", releaseYear: "2016", description: """
                ...
                Book(title: "The Miracle Morning: The Not-So-Obvious Secret Guaranteed to Transform Your Life (Before 8AM)", author: "Hal Elrod ", coverArt: "MiracleMorning", releaseYear: "2012", description: """
                ...
                Book(title: "The ONE Thing: The Surprisingly Simple Truth About Extraordinary Results", author: "Gary Keller ", coverArt: "TheOneThing", releaseYear: "2013", description: """
        ...
        """),
                ...
                Book(title: "Never Split the Difference: Negotiating As If Your Life Depended On It ", author: "Chris Voss", coverArt: "NeverSplit", releaseYear: "2016", description: """
        ...
        """),
                Book(title: "Outliers: The Story of Success", author: "Malcolm Gladwell", coverArt: "Outliers", releaseYear: "2008", description: """
        ...
        """),
                Book(title: "The Design of Everyday Things: Revised and Expanded Edition", author: "Don Norman", coverArt: "DesignEveryday", releaseYear: "2013", description: """
        ...
        """),
                ...
                Book(title: "Think Like a Programmer: An Introduction to Creative Problem Solving", author: "V. Anton Spraul ", coverArt: "ThinkLikeProgrammer", releaseYear: "2012", description: """
                ...
                Book(title: "Atomic Habits: An Easy & Proven Way to Build Good Habits & Break Bad Ones ", author: "James Clear ", coverArt: "AtomicHabbit", releaseYear: "2018", description: """
        ...
        """),
                Book(title: "The Clean Coder: A Code of Conduct for Professional Programmers", author: "Robert Cecil Martin", coverArt: "CleanCoder", releaseYear: "2011", description: """
        ...
        """),
                ...
                Book(title: "Cracking the Coding Interview: 189 Programming Questions and Solutions", author: "Gayle Laakmann McDowell ", coverArt: "CrackingInterview", releaseYear: "2015", description: """
        May be available at a lower price from other sellers, potentially without free Prime shipping.
